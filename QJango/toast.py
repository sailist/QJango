...
class ToastNotifier(object):
    ...
    def _destroy_wrap(self, func=None):
        print('wrap')
    ...
    @staticmethod
    def make_toast(title="Notification", msg="Here comes the message",
                   icon_path=None, duration=5, threaded=True, callback_on_click=None):
        """Notification settings.
        :title: notification title
        :msg: notification message
        :icon_path: path to the .ico file to custom notification
        ...
        """
        self = ToastNotifier()
        return self.show_toast(title=title,
                               msg=msg,
                               icon_path=icon_path,
                               duration=duration,
                               threaded=threaded,
